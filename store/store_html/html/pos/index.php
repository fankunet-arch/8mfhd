 ...
 * Revision: 2.1.0 (Add Refund Confirmation Modal)
 */
$cache_version = time();
?>
<!doctype html>
...
<body class="lefty-mode">
  <!-- Navbar -->
  <nav class="navbar navbar-expand bg-surface fixed-top shadow-sm border-0"><div class="container-fluid gap-2"><a class="navbar-brand d-flex align-items-center gap-2 fw-semibold" href="#"><span class="brand-dot"></span>TopTea POS<span class="badge bg-brand-soft text-brand fw-semibold ms-2" data-i18n="internal">Internal</span></a><div class="d-flex align-items-center ms-auto gap-2"><div class="dropdown"><button class="btn btn-outline-ink btn-sm dropdown-toggle px-2" data-bs-toggle="dropdown" id="lang_toggle"><span class="flag">🇨🇳</span> <span data-i18n="lang_zh">中文</span></button><ul class="dropdown-menu"><li><a class="dropdown-item active" href="#" data-lang="zh"><span class="flag">🇨🇳</span> 中文</a></li><li><a class="dropdown-item" href="#" data-lang="es"><span class="flag">🇪🇸</span> Español</a></li></ul></div><button class="btn btn-brand btn-sm" id="btn_sync" title="同步/刷新"><i class="bi bi-arrow-repeat"></i></button></div></div></nav>
  ...
  <!-- --- CORE ADDITION: Refund Confirmation Modal --- -->
  ...
  <!-- Print Preview Modal (Added by print.js if not present) -->
  <!-- <div class="modal fade" id="printPreviewModal"> ... </div> -->
